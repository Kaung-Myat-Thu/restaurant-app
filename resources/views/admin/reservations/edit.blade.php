                ...
                <div class="lg:w-1/2 xl:pl-4 px-4 py-2">
                    <form method="POST" action="{{ route('admin.reservations.update', $reservation->id) }}">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <input value="{{ old('first_name', $reservation->first_name) }}" name="first_name"
                                type="text"
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <input value="{{ old('last_name', $reservation->last_name) }}" name="last_name"
                                type="text"
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <input value="{{ old('email', $reservation->email) }}" name="email" type="email"
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <input value="{{ old('ph_number', $reservation->ph_number) }}" name="ph_number"
                                type="number"
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <input value="{{ old('res_date', $reservation->res_date) }}" name="res_date"
                                type="datetime-local"
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <input value="{{ old('guest_number', $reservation->guest_number) }}" name="guest_number"
                                type="number"
