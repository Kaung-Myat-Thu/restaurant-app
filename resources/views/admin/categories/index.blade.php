                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="even:bg-gray-50 border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="py-4 px-6">
                                <img src="{{ Storage::url($category->image) }}" alt="{{ $category->name }}" class="w-16 h-16 rounded">
                            </td>
                            <td class="py-4 px-6">
                                {{ $category->description }}
                            </td>
                            <td class="py-4 px-6 text-right flex gap-2 items-center justify-center">
                                <a href="{{ route('admin.categories.edit', $category->id) }}" class="font-medium text-white bg-green-500 hover:bg-green-700 px-4 py-2 rounded">Edit</a>
